...
function ensureFreeOverlay(){
 ...
 o.innerHTML=`<div class="free-burst"></div><div class="free-card">
   <small id="freeOverlayKicker">BONUS</small>
   <h2 id="freeOverlayTitle">FREISPIELE</h2>
   <div id="freeOverlayBig" class="free-big">8</div>
   <p id="freeOverlayText">DAS BUCH WURDE GEFUNDEN</p>
...
async function showFreeIntro(count,sym){
 ...
 o.classList.remove("hidden","free-out");o.classList.add("free-in");
 await sleep(2400);o.classList.add("free-out");await sleep(500);o.classList.add("hidden");o.classList.remove("free-in","free-out");
}
